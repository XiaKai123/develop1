...
function(window, document) {
    ...
    function() {
        ...
        Skintools = {
            tpl: '<div class="site-skintools"><div class="site-skintools-inner"><div class="site-skintools-toggle"><i class="icon wb-settings primary-600"></i></div><div class="site-skintools-content"><div class="nav-tabs-horizontal"><ul role="tablist" data-plugin="nav-tabs" class="nav nav-tabs nav-tabs-line"><li role="presentation" class="active"><a role="tab" aria-controls="skintoolsSidebar" href="#skintoolsSidebar" data-toggle="tab" aria-expanded="true">菜单主题</a></li><li role="presentation"><a role="tab" aria-controls="skintoolsNavbar" href="#skintoolsNavbar" data-toggle="tab" aria-expanded="false">导航主题</a></li><li role="presentation"><a role="tab" aria-controls="skintoolsPrimary" href="#skintoolsPrimary" data-toggle="tab" aria-expanded="false">系统主题</a></li></ul><div class="tab-content"><div role="tabpanel" id="skintoolsSidebar" class="tab-pane active"></div><div role="tabpanel" id="skintoolsNavbar" class="tab-pane"></div><div role="tabpanel" id="skintoolsPrimary" class="tab-pane"></div><button class="btn btn-outline btn-block btn-primary margin-top-20" id="skintoolsReset" type="button">重 置</button></div></div></div></div></div>',
            ...
            init: function() {
                ...
                this.build(this.$sidebar, this.skintoolsSidebar, "skintoolsSidebar", "radio", "菜单皮肤"),
                //this.build(this.$navbar, ["inverse"], "skintoolsNavbar", "checkbox", "导航类型"),
                this.build(this.$navbar, this.skintoolsNavbar, "skintoolsNavbar", "radio", "导航皮肤"),
                this.build(this.$primary, this.skintoolsPrimary, "skintoolsPrimary", "radio", "系统皮肤"),
                this.$container.appendTo($body),
                this.$toggle.on("click",
                function() {
                    self.$container.toggleClass("is-open")
                }),
                $("#skintoolsSidebar input").on("click",
                function() {
                ...
                $("#skintoolsPrimary input").on("click",
                function() {
            ...
            initLocalStorage: function() {
                ...
                function(n, v) {
                    switch (n) {
                    case "sidebar":
                        $('input[value="' + v + '"]', self.$sidebar).prop("checked", !0),
                    ...
                    case "navbarInverse":
                        ...
                        break;
                    case "primary":
                        $('input[value="' + v + '"]', self.$primary).prop("checked", !0),
