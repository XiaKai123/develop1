...
public class ReturnConstant {
	...
	public static String ERROR_MESSAGE_40002 = "操作数据库失败";
	public static String ERROR_CODE_40003 = "40003";
	public static String ERROR_MESSAGE_40003 = "下载文件失败";
	public static String ERROR_CODE_40004 = "40004";
	public static String ERROR_MESSAGE_40004 = "处理数据异常";
	...
	public static String ERROR_MESSAGE_40007= "字典代码校验不合法";
	public static String ERROR_CODE_40008 = "40008";
	public static String ERROR_MESSAGE_40008= "数据检验不合法";
	public static String ERROR_CODE_40009 = "40009";
	public static String ERROR_MESSAGE_40009= "参数长度不合法";
	public static String ERROR_CODE_40010 = "40010";
	public static String ERROR_MESSAGE_40010= "离线数据下载处理发生异常";
